...
TxController.prototype.transformTransaction = function(transaction, options, callback) {
  ...
  if(transaction.height >= 0) {
    confirmations = this.node.services.lbchd.height - transaction.height + 1;
  }
  ...
  var transformed = {
    ...
    islpp20Transfer: transaction.islpp20Transfer,
  };
...
TxController.prototype.transformLBChTransaction = function(transaction) {
